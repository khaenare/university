# Коефіцієнти системи
m11, m12, m21, m22 = 1, 0, 2, -1 # Коефіцієнти
...
color="red")
# Центральні розв’язки задачі Коші
...
# Додаткові лінії з боків
# Рівномірно розподіляємо початкові умови
additional_lines = 20 # Кількість додаткових ліній
step = plotRange / (additional_lines // 2)
for i in range(-plotRange, plotRange + 1, int(step)):
