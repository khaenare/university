...
6.1. DOM-парсер
Файл: DomTouristVouchersParser.java
...
6.2. SAX-парсер
Файл: SaxTouristVouchersParser.java
...
6.3. StAX-парсер
Файл: StaxTouristVouchersParser.java
...
Файл: TouristVoucherCostComparator.java
...
Файл: TouristVoucherDaysComparator.java
...
Групує всі <tourist_voucher> за значенням елемента <type>.
...
Валідація XML-документа tourist_vouchers.xml за XSD tourist_vouchers.xsd.
Парсинг XML трьома парсерами: DOM, SAX, StAX.
Виведення кількості об’єктів, отриманих кожним парсером.
Сортування колекції путівок:
за вартістю;
за кількістю днів.
Запуск XSLT-перетворення для групування путівок за типом
