...
import { createWriteOff, getProducts, getWriteOffs, ProductOption, WriteOffItem } from "@/lib/api";
      ...
      <section className="resource-layout">
        ...
        <article className="panel">
          ...
          <table className="table">
            <thead><tr><th>Reason</th><th>Lines</th><th>Created At</th></tr></thead>
            <tbody>
              {items.length === 0 ? (
                <tr><td colSpan={3} className="empty-cell">No write-offs yet.</td></tr>
              ) : (
                items.map((item) => (
                  <tr key={item.id}>
